...
Terraform module that provisions Amazon Route 53 hosted zones and DNS records.
...
module "terraform-aws-route53-module" {
  source = "git::https://github.com/thecloudsolutions/terraform-aws-route53-module.git"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_route53"></a> [route53](#module\_route53) | git::https://github.com/thecloudsolutions/terraform-aws-route53-component.git | main |
